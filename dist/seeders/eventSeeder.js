...
const seedEvents = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Insert new events
        const createdEvents = yield event_1.default.insertMany(eventData);
        console.log(`✅ Successfully seeded ${createdEvents.length} events`);
        // Log created events
        createdEvents.forEach((eventItem, index) => {
...
//# sourceMappingURL=eventSeeder.js.map