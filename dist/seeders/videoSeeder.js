...
const seedVideos = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const adminUser = yield User.findOne({ userType: { $exists: true } });
        if (!adminUser) {
        ...
        // Insert new videos
        const createdVideos = yield video_1.default.insertMany(videoData);
        console.log(`✅ Successfully seeded ${createdVideos.length} videos`);
        // Log created videos
        createdVideos.forEach((videoItem, index) => {
...
//# sourceMappingURL=videoSeeder.js.map