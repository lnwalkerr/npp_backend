...
function seedNews() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newsWithCreatedBy = newsData.map(newsItem => (Object.assign(Object.assign({}, newsItem), { created_by: adminUser._id })));
            // Clear existing news
            yield news_1.default.deleteMany({});
            console.log("🗑️ Cleared existing news articles");
            // Insert new news
            const createdNews = yield news_1.default.insertMany(newsWithCreatedBy);
            console.log(`✅ Successfully seeded ${createdNews.length} news articles`);
            // Log created news
            createdNews.forEach((newsItem, index) => {
...
//# sourceMappingURL=newsSeeder.js.map